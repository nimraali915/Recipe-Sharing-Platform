	...
	%>
			<div class="col-md-3 my-3 mx-3">
				...
				<div class="card" style="width: 18rem;">
					...
					<div class="card-body">
						<h5 class="card-title"><h4>RecipeName:</h4> <%= resultset.getString(2) %></h5>
						<p class="card-text"><h5>Category:</h5> <%= resultset.getString(3) %></p>
						<p class="card-text"><h5>Procedure: </h5><%= resultset.getString(4) %></p>
